$(function(){
	...
	var $lienAjout = $('<a href="" id="ajout_fichier" class="btn blue waves-effect waves-dark">Nouvelle Photo</a> <br/><br/>');
	...
	function ajouterLienSuppression($prototype) {
		$lienSuppression = $('<br/> <a href="" class="btn red waves-effect waves-dark">Supprimer</a> <br/> <br/>');
