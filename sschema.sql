...
CREATE TABLE `comment` (
  ...
  KEY `IDX_9474526C3D5814AC` (`commit_id`),
  CONSTRAINT `FK_9474526C3D5814AC` FOREIGN KEY (`commit_id`) REFERENCES `commit` (`id`),
  CONSTRAINT `FK_9474526C8E46E9DE` FOREIGN KEY (`participator_id`) REFERENCES `participator` (`id`),
...
CREATE TABLE `commit` (
  ...
  CONSTRAINT `FK_4ED42EAD8E46E9DE` FOREIGN KEY (`participator_id`) REFERENCES `participator` (`id`),
...
CREATE TABLE `commit_historic` (
  ...
  CONSTRAINT `FK_105BF3A33D5814AC` FOREIGN KEY (`commit_id`) REFERENCES `commit` (`id`),
  CONSTRAINT `FK_105BF3A38DB60186` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `historic` (
  ...
  CONSTRAINT `FK_AD52EF56166D1F9C` FOREIGN KEY (`project_id`) REFERENCES `projet` (`id`),
  CONSTRAINT `FK_AD52EF568E46E9DE` FOREIGN KEY (`participator_id`) REFERENCES `participator` (`id`)
...
CREATE TABLE `participator` (
  ...
  CONSTRAINT `FK_BEE9AD38A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `planning` (
  ...
  CONSTRAINT `FK_D499BFF6166D1F9C` FOREIGN KEY (`project_id`) REFERENCES `projet` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task` (
  ...
  CONSTRAINT `FK_527EDB253D865311` FOREIGN KEY (`planning_id`) REFERENCES `planning` (`id`),
...
-- Dump completed on 2017-05-22 18:59:48
